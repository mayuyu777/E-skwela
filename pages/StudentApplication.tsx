...
export default function StudentApplication({
  ...
  const [isSameWithCurAddress, setIsSameWithCurAddress] =
    useState(false);
              ...
              <CardBody p={'0pc'} pb={'5pc'}>
                ...
                >
                  <Text
                    ...
                    fontWeight={'medium'}
                  >
                    NOTE: Please fill-out the form carefully and
                    honestly.
                  </Text>
                </Flex>
                <Grid
                ...
                >
                  <TextField
                    label={
                      'Please provide an email to where we can contact you.'
                    }
                    withError={true}
                    name="email"
                    type="email"
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      {schoolYears.map((item) => {
                        return (
                          <option
                            key={item.school_yr_id}
                            value={item.school_yr_id}
                          >
                  ...
                  <FormControl
                    isInvalid={
                      formik.errors.year_level !== '' &&
                      formik.touched.year_level
                    }
                  >
                    <FormLabel
                      fontSize={'13px'}
                ...
                >
                  <Text
                    ...
                    color={'blue.900'}
                  >
                    V. For Returning Learner and those who will
                    transfer/move In
                  </Text>
                  <Box
                    w={'full'}
