...
export default async function handler(req:NextRequest, res:NextResponse) {
    ...
    try {
        ...
        res.status(200).send({message: 'Your application has been successfully submitted. Please check your email for updates regarding your application. Thank you.', ok: true});
    } catch (error) {
        console.log(error);
